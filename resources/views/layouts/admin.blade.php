        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar" id="sidebar">
                ...
                <ul class="nav flex-column">
                    ...
                    @if(Auth::user()->role === 'super_admin' || Auth::user()->hasPermission('manage_enrollment'))
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.acudientes.*') ? 'active' : '' }}" href="{{ route('admin.acudientes.index') }}">
                            <i class="bi bi-person-heart"></i> Acudientes
                        </a>
                    </li>
                    @endif 
                    ...
                    @if(Auth::user()->role === 'super_admin' || Auth::user()->hasPermission('manage_enrollment'))
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.madres.*') ? 'active' : '' }}" href="{{ route('admin.madres.index') }}">
                            <i class="bi bi-gender-female"></i> Madres
                        </a>
                    </li>
                    @endif
                    ...
                    @if(Auth::user()->role === 'super_admin' || Auth::user()->hasPermission('manage_enrollment'))
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.padres.*') ? 'active' : '' }}" href="{{ route('admin.padres.index') }}">
                            <i class="bi bi-gender-male"></i> Padres
                        </a>
                    </li>
                    @endif
                    ...
                    @if(Auth::user()->role === 'super_admin' || Auth::user()->hasPermission('manage_enrollment'))
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.sede-educativas.*') ? 'active' : '' }}" href="{{ route('admin.sede-educativas.index') }}">
                            <i class="bi bi-building"></i> Sedes Educativas
                        </a>
                    </li>
                    @endif
                    ...
                    @if(Auth::user()->role === 'super_admin' || Auth::user()->hasPermission('manage_enrollment'))
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.grados.*') ? 'active' : '' }}" href="{{ route('admin.grados.index') }}">
                            <i class="bi bi-mortarboard-fill"></i> Grados
                        </a>
                    </li>
                    @endif
                    ...
                    @if(Auth::user()->role === 'super_admin' || Auth::user()->hasPermission('manage_enrollment'))
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.tipo-documentos.*') ? 'active' : '' }}" href="{{ route('admin.tipo-documentos.index') }}">
                    ...
                    @if(Auth::user()->role === 'super_admin' || Auth::user()->hasPermission('manage_enrollment'))
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.generos.*') ? 'active' : '' }}" href="{{ route('admin.generos.index') }}">
                    ...
                    @if(Auth::user()->role === 'super_admin' || Auth::user()->hasPermission('manage_enrollment'))
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.tipo-sangres.*') ? 'active' : '' }}" href="{{ route('admin.tipo-sangres.index') }}">
                            <i class="bi bi-droplet"></i> Tipos de Sangre
                        </a>
                    </li>
                    @endif
                    ...
                    @if(Auth::user()->role === 'super_admin' || Auth::user()->hasPermission('manage_enrollment'))
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.eps.*') ? 'active' : '' }}" href="{{ route('admin.eps.index') }}">
                    ...
                    @if(Auth::user()->role === 'super_admin' || Auth::user()->hasPermission('manage_enrollment'))
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.grupo-etnicos.*') ? 'active' : '' }}" href="{{ route('admin.grupo-etnicos.index') }}">
                            <i class="bi bi-globe"></i> Grupos Étnicos
                        </a>
                    </li>
                    @endif
